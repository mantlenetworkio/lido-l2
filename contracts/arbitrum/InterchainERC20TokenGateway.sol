...
abstract contract InterchainERC20TokenGateway is BridgingManager, BridgeableTokens, IInterchainTokenGateway {
    ...
    constructor(address router_, address counterpartGateway_, address l1Token_, address l2Token_)
    ...
    function getOutboundCalldata(
        ...
        return abi.encodeWithSelector(
            IInterchainTokenGateway.finalizeInboundTransfer.selector, l1Token_, from_, to_, amount_, ""
        );
    }
}
